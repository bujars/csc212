...
/*NOTE the way I did it below defeats the purpose of heapsort 
 * because it allocates too much space. */
...
void heapSort(int arr[], size_t size){
	...
	while(i > 1){
		...
		arr[0] = arr[i]; 
		arr[i] = temp;
		reheapify_down(arr, i); /*Make sure max is always at the top by rearragning.*/
	}
